...
<script src="<?php echo base_url() ?>assets/admin/assets/js/dropzone.js"></script>


<script src="<?php echo base_url() ?>assets/admin/assets/js/bootstrap-datepicker.js"></script>    
<script src="<?php echo base_url() ?>assets/admin/assets/js/bootstrap-datetimepicker.js"></script>    
