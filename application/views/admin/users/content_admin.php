...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/users/admin_ajax_list')?>",
            "type": "POST"
        },
...
function edit_admin(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/users/admin_ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/users/admin_ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/users/admin_ajax_update')?>";
    }
...
function delete_admin(id)
{
    if(confirm('Apa anda yakin ingin menghapus data ini?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/users/admin_ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
