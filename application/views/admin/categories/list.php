        ...
        <button class="btn btn-success" onclick="add_category()"><i class="glyphicon glyphicon-plus"></i> Tambah Kategori</button>
...
function edit_category(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/categories/ajax_edit/')?>/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="order_category"]').val(data.order_category);
...
function delete_category(id)
{
    if(confirm('Apa anda yakin ingin menghapus data ini?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/categories/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="order_category" placeholder="Urutan" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="category_description" placeholder="Keterangan" class="form-control"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
